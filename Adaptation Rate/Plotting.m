...
load('Data\sol_A_max_10_gradient_1.mat')

numSamples = length(simulationParameters.times);

curveIncrement = floor(numSamples/50); % increments between plotted curves
highlightedCurve = 51; %index of the highlighted curve
