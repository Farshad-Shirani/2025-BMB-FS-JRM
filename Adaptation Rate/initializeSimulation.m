...
V_u = 15;    % variance of the within phenotipic-resource utility curve (V_u = V where V is defined in Table 1)
...
A_max = 4 * ones(I, 1); % maximum velocity adjustment for optimal advective dispersal (coefficient of the optimal dispersal term)
